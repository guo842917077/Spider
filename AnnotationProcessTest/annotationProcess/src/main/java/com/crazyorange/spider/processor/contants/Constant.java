...
public class Constant {
    ...
    public static final String SPIDER_ROOT_CLASS_PREFIX = PROJECT + SEPARATOR + "Root";
    /**
     *
     */
    public static final String GROUP_PACKAGE = "com.crazyorange.spider.group";
    public static final String ROOT_PACKAGE = "com.crazyorange.spider.root";
    public static final String GROUP_INTERFACE_ISPIDER_GROUP =
            "com.crazyorange.spider.group.ISpiderGroup";
    public static final String GROUP_INTERFACE_ISPIDER_ROOT =
            "com.crazyorange.spider.group.ISpiderRoot";
    ...
    public static final String PARAM_NAME = "container";
